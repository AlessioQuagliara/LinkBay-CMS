...
from models import User, ShopList, Page, WebSettings, CookiePolicy, CMSAddon, UserStoreAccess, Products, Collections, Categories, Orders, Customers, Payments, Shipping, ShippingMethods
...
# ORDINI, GESTIONE ORDINI, CLIENTI E GESTIONE CLIENTI ---------------------------------------------------------------------------------------
# ORDERS (ORDINI) -------------------------------- >

@app.route('/admin/cms/pages/orders', methods=['GET'])
def orders():
    username = check_user_authentication()
    if isinstance(username, str):
...
@app.route('/admin/cms/pages/order/<int:order_id>', methods=['GET', 'POST'])
@app.route('/admin/cms/pages/order', defaults={'order_id': None}, methods=['GET', 'POST'])
...
@app.route('/admin/cms/pages/order-list/<int:order_id>', methods=['GET', 'POST'])
@app.route('/admin/cms/pages/order-list/', methods=['GET', 'POST'])
...
@app.route('/admin/cms/create_order', methods=['POST'])
def create_order():
    try:
        data = request.get_json() 
...
@app.route('/admin/cms/delete_orders', methods=['POST'])
def delete_order():
    try:
...
@app.route('/admin/cms/update_order', methods=['POST'])
def update_order():
    try:
...
@app.route('/admin/cms/customers', methods=['GET'])
def get_customers():
    try:
...
@app.route('/admin/cms/customer/<int:customer_id>', methods=['GET'])
...
@app.route('/admin/cms/add_product_to_order', methods=['POST'])
def add_product_to_order():
    try:
        ...
        print(f"Error in add_product_to_order route: {e}")
        return jsonify({'success': False, 'message': 'An unexpected error occurred.'}), 500
    
@app.route('/admin/cms/remove_products_from_order', methods=['POST'])
def remove_products_from_order():
    try:
        ...
        print(f"Error removing products from order: {e}")
        return jsonify({'success': False, 'message': 'An error occurred.'}), 500
    
@app.route('/admin/cms/get_products_by_ids', methods=['POST'])
def get_products_by_ids():
    try:
        ...
        print(f"Error retrieving products by IDs: {e}")
        return jsonify({'success': False, 'message': 'An error occurred while fetching products.'}), 500
    
@app.route('/admin/cms/add_products_to_order', methods=['POST'])
...
@app.route('/admin/cms/update_order_quantities', methods=['POST'])
def update_order_quantities():
    try:
        ...
        print(f"Error updating order quantities: {e}")
        return jsonify({'success': False, 'message': 'An error occurred.'}), 500
...
@app.route('/admin/cms/create_customer', methods=['POST'])
def create_customer():
    try:
        shop_subdomain = request.host.split('.')[0] 
...
@app.route('/admin/cms/pages/customer/<int:customer_id>', methods=['GET', 'POST'])
@app.route('/admin/cms/pages/customer', methods=['GET', 'POST'])
...
@app.route('/admin/cms/update_customer', methods=['POST'])
def update_customer():
    try:
...
@app.route('/admin/cms/delete_customers', methods=['POST'])
...
# GETIONE DELLE SPEDIZIONI ---------------------------------------------------------------------------------------

# SPEDIZIONI -------------------------------- >

@app.route('/admin/cms/pages/shipping-methods')
...
@app.route('/admin/cms/create_shipping_method', methods=['POST'])
...
@app.route('/admin/cms/delete_shippings', methods=['POST'])
...
@app.route('/admin/cms/pages/shipping-method/<int:method_id>', methods=['GET', 'POST'])
@app.route('/admin/cms/pages/shipping-method', methods=['GET', 'POST'])
...
@app.route('/admin/cms/update_shipping_method', methods=['POST'])
