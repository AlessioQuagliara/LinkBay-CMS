  ...
  <main className="min-h-screen overflow-hidden">
    ...
    <section className="py-20 bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            A Chi Si Rivolge <span className="font-linkbay">LinkBay-CMS</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
    ...
    <section className="relative bg-gradient-to-r from-gray-900 to-red-900 text-white py-20">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl mb-8 opacity-90">
          Unisciti alle agenzie che stanno già scalando con <span className="font-linkbay">LinkBay-CMS</span>
        </p>
