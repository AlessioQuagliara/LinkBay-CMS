...
export default function NotFound() {
  ...
  <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 flex items-center justify-center relative overflow-hidden">
    ...
    <div className="absolute top-1/3 right-1/3 opacity-5 animate-float">
    ...
    <main className="max-w-2xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-lg mx-auto mb-8">
          Forse stavi cercando una funzionalità dell&apos;arsenale <span className="font-linkbay">LinkBay-CMS</span> che verrà 
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/pricing" className="text-[#343a4D] hover:text-[#ff5758] transition-colors duration-300 text-sm">
            Pricing
          </Link>
          <Link href="/about" className="text-[#343a4D] hover:text-[#ff5758] transition-colors duration-300 text-sm">
            Chi Siamo
          </Link>
          <Link href="/contact" className="text-[#343a4D] hover:text-[#ff5758] transition-colors duration-300 text-sm">
            Contatti
          </Link>
          <Link href="/blog" className="text-[#343a4D] hover:text-[#ff5758] transition-colors duration-300 text-sm">
            Blog
          </Link>
        </div>
      </div>
