...
export default function CheckoutError({
  ...
  useEffect(() => {
    console.error('[checkout] errore non gestito:', error)
  }, [error])
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-12rem)] max-w-lg flex-col items-center justify-center px-4 py-16 text-center sm:px-6">
      ...
      <h1 className="text-xl font-bold text-gray-900">
        Problema durante il caricamento del checkout
      </h1>
      <p className="mt-2 text-sm text-gray-500">
        Il carrello e i tuoi dati non sono andati persi. Riprova, oppure torna al
        negozio e ricomincia da lì.
      </p>
