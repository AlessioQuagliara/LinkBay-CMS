...
export const metadata: Metadata = {
  title: "Funzionalità - LinkBay CMS",
...
const techStack = [
  { name: "Python & TypeScript", category: "Linguaggio" },
  { name: "FastAPI + Cython", category: "Backend" },
  { name: "PostgreSQL", category: "Database" },
  { name: "Next.JS TURBOPACK", category: "Frontend" },
  { name: "Tailwind CSS 3.4", category: "Styling" },
  { name: "Docker Containers + Traefik", category: "Infrastruttura" },
  { name: "Redis Cache + C Scripting", category: "Performance" },
