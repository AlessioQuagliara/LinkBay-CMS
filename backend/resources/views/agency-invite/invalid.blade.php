...
<div class="w-full max-w-md text-center">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-10">
        ...
        @if($reason === 'expired')
            <h1 class="text-2xl font-bold text-[#343a4D] mb-2">Invito scaduto</h1>
            <p class="text-gray-500 text-sm mb-8">
                Questo invito è scaduto. Chiedi all'owner dell'agency di inviartene uno nuovo.
            </p>
        @else
            <h1 class="text-2xl font-bold text-[#343a4D] mb-2">Invito non valido</h1>
            <p class="text-gray-500 text-sm mb-8">
                Questo link di invito non è valido o è già stato utilizzato.
                Se pensi ci sia un errore, contatta l'owner dell'agency.
            </p>
        @endif
    </div>
