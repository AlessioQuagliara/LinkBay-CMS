...
<head>
    ...
    <title>Accesso attivato — {{ config('app.name') }}</title>
...
<div class="w-full max-w-md text-center">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-10">
        ...
        <h1 class="text-2xl font-bold text-[#343a4D] mb-2">Accesso attivato</h1>

        @if($storeName)
            <p class="text-gray-600 text-sm mb-1">
                Puoi ora accedere al pannello di <span class="font-semibold">{{ $storeName }}</span>.
            </p>
        @endif
