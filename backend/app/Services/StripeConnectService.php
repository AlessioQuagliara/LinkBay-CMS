...
class StripeConnectService
{
     ...
     * The returned URL is single-use and short-lived (~5 minutes).
     *
     * @throws ApiErrorException when the account is not eligible or Stripe fails
     */
    public function createLoginLink(Agency $agency): string
    {
        if (! $agency->stripe_connect_account_id) {
            throw new \RuntimeException('Agency has no Stripe Connect account.');
        }

        return Account::createLoginLink($agency->stripe_connect_account_id)->url;
    }
